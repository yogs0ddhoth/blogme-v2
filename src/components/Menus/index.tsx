...
export const MenuAction = ({onClick, label, icon, action}:MenuActionProps) => (
  <MenuItem onClick={
    () => {
...
export const ActionsMenu = (props:ActionMenuProps) => {
  ...
  return (
    <div className={props.className !== undefined ? props.className : ''}>
      <MenuButton className={props.anchorEl !== undefined && props.anchorEl.className !== undefined ? props.anchorEl.className : ''}
        onClick={handleClick}
      />
